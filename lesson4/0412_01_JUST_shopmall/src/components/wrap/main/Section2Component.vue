<template>
  <section id="section2">
    <div class="left">
      <div class="container">
        <div class="title">
          <button :class="[notice-btn , {'on': gallery}]" title="공지사항" @click='clickNotice'>공지사항</button>
          <button :class="[gallery-btn , {'on': gallery}]" title="갤러리" @click='clickGallery'>갤러리</button>
        </div>
        <div class="content">
          <div :class="['notice-box', {'on': gallery}]">
            <ul>
              <li>
                ...
                href="#" 
                class="popup-btn" 
                title="9월 just 쇼핑몰 세일 안내!"
                @click="clickModalOpen('9월 just 쇼핑몰 세일 안내!')"
                  >9월 just 쇼핑몰 세일 안내!</a
...
/* 공지사항버튼 */
#wrap #main #section2 .left .container .title button.notice-btn {
...
/* 갤러리버튼 */
#wrap #main #section2 .left .container .title button.gallery-btn {
  border: 1px solid #ccc;
  background: #f3f3f3;
  cursor: pointer;
}
...
#wrap #main #section2 .left .container .content div.notice-box ul li span {
  color: #999;
  font-size: 13px;
}
